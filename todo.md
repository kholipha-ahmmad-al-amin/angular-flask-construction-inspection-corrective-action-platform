# Project TODO
- [x] Implement inspection, finding, corrective action, verification, and audit domain workflows.
- [x] Implement role-specific API key authorization for inspection operations.
- [x] Build an Angular workspace and LAN-bound Flask API using port 11500.
